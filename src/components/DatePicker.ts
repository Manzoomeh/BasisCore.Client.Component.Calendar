...
export class DatePicker {
  ...
  nextMonth(nextButtonWrapper: HTMLElement): void {
    if (this.options.disabledPrevButton) {
      nextButtonWrapper.previousElementSibling.previousElementSibling.removeAttribute(
        "data-disabled-prev"
      );
    }
  ...
  prevMonth(prevButtonWrapper: HTMLElement): void {
    if (this.options.disabledPrevButton) {
      ...
      if (
        objCurrentDate.year == this.activeMonth().value.year &&
        objCurrentDate.month == this.activeMonth().value.month
      ) {
      ...
      container.addEventListener("click", (e) => {
        ...
        if (this.options.rangeDates == false) {
          if (inputElement.getAttribute("data-datepicker-dateid") !== null) {
            ...
            inputElement.removeAttribute("data-datepicker-dateid");
            inputElement.removeAttribute("data-datepicker-sstring");
          }
        } else {
          if (inputElement.getAttribute("data-datepicker-to-dateid") !== null) {
            ...
            inputElement.setAttribute("value", "");
            inputElement.removeAttribute("data-datepicker-dateid");
            inputElement.removeAttribute("data-datepicker-to-dateid");
            inputElement.removeAttribute("data-datepicker-sstring");
            inputElement.removeAttribute("data-datepicker-to-sstring");
          }
        }
        e.stopPropagation();
        container.parentNode.insertBefore(this.wrapper, container.nextSibling);
