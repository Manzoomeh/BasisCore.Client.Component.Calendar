...
export class UiMbobile {
  ...
  generateNoteForm(note?: INote, creator?: number): HTMLElement {
    ...
    if (this.range.categories.length == 0) {
      ...
      errDiv.textContent =
        "از ویجت دسته‌بندی‌ها، یک دسته‌بندی جدید ایجاد کنید.";
    ...
    if (note) {
      ...
      const catsText = editCodeWrapper.querySelector(
  ...
  generateShareForm(note?: INote): Node {
    ...
    const sharingParent = formWrapper.querySelector(
      "[data-calendar-share-form-uniqe]"
    );
  ...
  async createReminderList(id: number, body: HTMLElement) {
    ...
    if (viewNote[0]?.reminders?.length > 0) {
      viewNote[0]?.reminders.forEach((reminderItem) => {
        ...
        if (actionidVal == 1) {
          reminderItemDiv.querySelector(
            "[data-bc-calendar-action-icon]"
          ).innerHTML = `<div data-bc-calendar-action-icon-container=''><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 15 16" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd" d="M3.08579 4.58579C2.5 5.17157 2.5 6.11438 2.5 8C2.5 9.88562 2.5 10.8284 3.08579 11.4142C3.67157 12 4.61438 12 6.5 12H8.5C10.3856 12 11.3284 12 11.9142 11.4142C12.5 10.8284 12.5 9.88562 12.5 8C12.5 6.11438 12.5 5.17157 11.9142 4.58579C11.3284 4 10.3856 4 8.5 4H6.5C4.61438 4 3.67157 4 3.08579 4.58579ZM10.7881 5.75993C10.9207 5.91903 10.8992 6.1555 10.7401 6.28808L9.64183 7.20328C9.19865 7.57261 8.83944 7.87196 8.52241 8.07586C8.19216 8.28826 7.87054 8.42244 7.5 8.42244C7.12946 8.42244 6.80784 8.28826 6.47759 8.07586C6.16056 7.87196 5.80136 7.57262 5.35818 7.20329L4.25993 6.28808C4.10083 6.1555 4.07933 5.91903 4.21192 5.75993C4.3445 5.60083 4.58097 5.57933 4.74007 5.71192L5.81952 6.61146C6.286 7.00019 6.60986 7.26921 6.88329 7.44506C7.14797 7.61529 7.32746 7.67244 7.5 7.67244C7.67254 7.67244 7.85203 7.61529 8.11671 7.44506C8.39013 7.26921 8.714 7.00019 9.18048 6.61146L10.2599 5.71192C10.419 5.57933 10.6555 5.60083 10.7881 5.75993Z" fill="#004B85"/>
        </svg>ایمیل</div>`;
        } else {
          reminderItemDiv.querySelector(
            "[data-bc-calendar-action-icon]"
          ).innerHTML = `<div data-bc-calendar-action-icon-container=''><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 15 16" fill="none">
          <path d="M12.5 6.25C12.5 4.45507 11.0449 3 9.25 3C8.20856 3 7.28154 3.49115 6.68675 4.2536C9.22354 4.35168 11.25 6.43919 11.25 9C11.25 9.05516 11.2491 9.11009 11.2472 9.16479L11.4133 9.20924C11.8965 9.33852 12.3385 8.89649 12.2092 8.41333L12.1456 8.17531C12.0941 7.98303 12.125 7.7799 12.2077 7.59886C12.3954 7.18799 12.5 6.73121 12.5 6.25Z" fill="#004B85"/>
          <path fill-rule="evenodd" clip-rule="evenodd" d="M10.5 9C10.5 11.2091 8.70914 13 6.5 13C5.88225 13 5.2972 12.86 4.77488 12.6099C4.59535 12.524 4.39197 12.4938 4.19969 12.5452L3.58667 12.7092C3.10351 12.8385 2.66148 12.3965 2.79076 11.9133L2.95478 11.3003C3.00622 11.108 2.97605 10.9046 2.8901 10.7251C2.64004 10.2028 2.5 9.61775 2.5 9C2.5 6.79086 4.29086 5 6.5 5C8.70914 5 10.5 6.79086 10.5 9ZM4.75 9.5C5.02614 9.5 5.25 9.27614 5.25 9C5.25 8.72386 5.02614 8.5 4.75 8.5C4.47386 8.5 4.25 8.72386 4.25 9C4.25 9.27614 4.47386 9.5 4.75 9.5ZM6.5 9.5C6.77614 9.5 7 9.27614 7 9C7 8.72386 6.77614 8.5 6.5 8.5C6.22386 8.5 6 8.72386 6 9C6 9.27614 6.22386 9.5 6.5 9.5ZM8.25 9.5C8.52614 9.5 8.75 9.27614 8.75 9C8.75 8.72386 8.52614 8.5 8.25 8.5C7.97386 8.5 7.75 8.72386 7.75 9C7.75 9.27614 7.97386 9.5 8.25 9.5Z" fill="#004B85"/>
        </svg>موبایل</div>`;
        }
        // if (actionidVal == 2) {
        //   reminderItemDiv
  ...
  generateNoteList(): HTMLElement {
    ...
    `;
    closeBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
    <path d="M0 10C0 4.47715 4.47715 0 10 0H25C30.5228 0 35 4.47715 35 10V25C35 30.5228 30.5228 35 25 35H10C4.47715 35 0 30.5228 0 25V10Z" fill="black" fill-opacity="0.1"/>
    <path d="M13.0413 12.0603L11.0614 14.0402L15.0212 18L11.0614 21.9598L13.0413 23.9397L17.0011 19.9799L20.9609 23.9397L22.9408 21.9598L18.981 18L22.9408 14.0402L20.9609 12.0603L17.0011 16.0201L13.0413 12.0603Z" fill="black"/>
  </svg>
    `;
   ...
   <div class="message"></div>
      ...
      reminderBtn?.addEventListener("click", async (e) => {
        (modalBtns.innerHTML = ""), modalBtns.appendChild(closeBtn);
        modalBody.innerHTML = "";
