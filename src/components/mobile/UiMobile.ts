...
export class UiMbobile {
  ...
  generateReminderRow(body: HTMLElement) {
    ...
    reminderRowBody.querySelector("[tab-button-status-email]").textContent =
      this.range.options.labels.email;
    reminderRowBody.querySelector("[tab-button-status-mobile]").textContent =
      this.range.options.labels.sms;

    let timeUnitSelect = reminderRowBody.querySelector("[data-bc-select-time]");
  ...
  generateNoteList(): HTMLElement {
   ...
   <div class="message"></div>
      ...
      if (x.creator == 0) {
        ...
        // }
        moreButton.querySelector("[data-view-btn]").textContent =
          this.range.options.labels.viewMenuTitle;
        moreButtonBox.querySelector("[reminder-button]").textContent =
        ...
        // }
        moreButtonBox.querySelector("[data-bc-view-btn]").textContent =
          this.range.options.labels.viewMenuTitle;
        moreButtonBox.querySelector("[reminder-button]").textContent =
          this.range.options.labels.reminderMenuTitle;
